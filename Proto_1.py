...
def main(root):
  ...
  canvas = Canvas(frame, bg="#300900", width=2000, height=2000, bd=0, cursor="circle")
  canvas.pack(fill=BOTH, expand=True)
  content = ttk.Frame(canvas, width=4000, height=4000, style='TFrame')
  ...
  vscrollbar = ttk.Scrollbar(content, orient=VERTICAL)
  vscrollbar.pack(fill=Y, side=RIGHT, expand=FALSE)
  canvas = Canvas(content, bd=0, highlightthickness=0,
  ...
  canvas.create_window(0, 0, window=content,
                                     anchor=NW)
